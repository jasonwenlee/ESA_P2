        ...
        */
        ...
        function fixFirstLine() {
            if($editor && !$editor.find(".richText-editor").html()) {
                ...
                if(settings.useParagraph !== false) {
                    // Set focus immediately to the html division within the editor
                    // upon initial display
                    $editor.find(".richText-editor").html('<p><br></p>').focus();
                } else {
                    // Set focus immediately to the html division within the editor
                    // upon initial display
                    $editor.find(".richText-editor").html('<div><br></div>').focus();
                }
            } else {
